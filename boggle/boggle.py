...
DICTIONARY_FOLDER = os.path.join(os.path.dirname(os.path.abspath(__file__)), "words")
...
def main():
    ...
    parser.add_argument(
        "--russian", action="store_true", help="Use the Russian alphabet for the board."
    )
    parser.add_argument(
        "--size",
        type=int,
        default=BOARD_SIDE_LENGTH,
...
class Board:
    ...
    def top_edge(self, index):
        return index < self.size

    def bottom_edge(self, index):
